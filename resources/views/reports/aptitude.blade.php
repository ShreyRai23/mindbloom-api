...
<head>
    <meta charset="UTF-8">
    <title>MindBloom AI — Aptitude Report</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-info">
            ...
            <div class="subtitle">MindBloom AI · Generated {{ $report->report_date->format('F j, Y') }}</div>
    ...
    <div class="footer">
        Generated by MindBloom AI 🌸 &middot; Powered by Gemini AI &middot; {{ now()->format('Y') }}
    </div>
